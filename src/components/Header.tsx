      ...
      <AnimatePresence>
        {announcementVisible && (
          <motion.div
            ...
            className="bg-foreground text-background overflow-hidden relative z-[60]"
          >
            <div className="container-full py-2.5 flex items-center justify-center gap-6">
              <p className="text-[10px] md:text-[11px] tracking-[0.2em] uppercase text-center">
                Complimentary shipping on orders over $500 —{" "}
                <Link to="/products" className="underline underline-offset-2 hover:text-background/80 transition-colors">
                  Shop Now
                </Link>
              </p>
              <button
                onClick={() => setAnnouncementVisible(false)}
                className="absolute right-4 md:right-8 top-1/2 -translate-y-1/2 text-background/40 hover:text-background/80 transition-colors"
              >
            ...
            <div className="flex items-center gap-1 md:gap-2 flex-1 justify-end">
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <button className="relative p-2.5 hover:bg-accent rounded-full transition-colors duration-300 group">
                    <Heart className="w-[18px] h-[18px] transition-transform duration-300 group-hover:scale-110" />
                    <AnimatePresence>
                      {items.length > 0 && (
                        <motion.span
                          initial={{ scale: 0 }}
                          animate={{ scale: 1 }}
                          exit={{ scale: 0 }}
                          className="absolute top-1 right-1 w-4 h-4 bg-primary text-primary-foreground text-[9px] font-bold rounded-full flex items-center justify-center"
                        >
              ...
              {/* Mobile menu button */}
              <button
                className="md:hidden p-2.5 hover:bg-accent rounded-full transition-colors duration-300"
